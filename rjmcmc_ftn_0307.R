...
Indi_ftn <- function(y_input, lambda1_input, lambda2_input, lambda3_input){
  
  
  log_w1 <- dpois(y_input, lambda1_input, log=T)
  log_w2 <- dpois(y_input, lambda2_input, log=T)
  log_w3 <- dpois(y_input, lambda3_input, log=T)
  ...
  indi_v <- numeric(length(y_input))
  for(k in 1:length(y_input)){
    indi_v[k] <- which.max(c(p1[k],p2[k],p3[k]))
  }
...
acc.birth.ar <- function(y_input, t_input, mvn_inputs, lambda1_input, lambda2_input, lambda3_input, hype_input, p_birth_input, p_death_input, active_input, rest_input, n_active_input, n_rest_input){
  ...
  if((end-start)>2){
    ...
    if(length(y_star)!=0){
      ...
      # indicator
      temp_indi <- Indi_ftn(y_star, lambda1_input, lambda2_input, lambda3_input)
      
      log_lkh_ratio <- log_mvn_lkh(y_star, t_star, mu, sigma2, l, g) - sum(dpois(y_star[temp_indi==1], lambda1_input, log=T)) - sum(dpois(y_star[temp_indi==2], lambda2_input, log=T)) - sum(dpois(y_star[temp_indi==3], lambda3_input, log=T)) 
...
acc.death.ar <- function(y_input, t_input, mvn_inputs, lambda1_input, lambda2_input, lambda3_input, hype_input, p_birth_input, p_death_input, active_input, rest_input, n_active_input, n_rest_input){
  ...
  if(length(y_star)!=0){
    ...
    log_lkh_ratio <-  sum(dpois(y_star[temp_indi==1], lambda1_input, log=T)) + sum(dpois(y_star[temp_indi==2], lambda2_input, log=T)) + sum(dpois(y_star[temp_indi==3], lambda3_input, log=T)) - log_mvn_lkh(y_star, t_star, mu, sigma2, l, g) 
...
acc.birth.ra <- function(y_input, t_input, mvn_inputs, lambda1_input, lambda2_input, lambda3_input, hype_input, p_birth_input, p_death_input, active_input, rest_input, n_active_input, n_rest_input){
...
acc.death.ra <- function(y_input, t_input, mvn_inputs, lambda1_input, lambda2_input, lambda3_input, hype_input , p_birth_input, p_death_input, active_input, rest_input, n_active_input, n_rest_input){
